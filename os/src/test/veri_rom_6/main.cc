...
enum { MY_THREADS = 2, ALL_THREADS = 30, EMULATED_PROGRAMS = 15 };
...
//	Test_thread t31(&start, &ready, 0b011110<<6, 0b011111<<6);
	...
	for (unsigned o = 256; o < 256+16; o += 4) {
		protect = (o & (0b11 << 9)) != (0b11 << 9);
		v1 = rom_0.read(o);
		v2 = v1 + 1;
		rom_0.write(o, v2);
		unsigned v3 = rom_0.read(o);
//		if (protect) { if ( v3 != v1) PDBG("Protect failed %u %x %x", o, v3, v1); }
		/*else*/ if (v3 != v2) PDBG("Write failed %x", o);
	}
...
[init -> vinit -> test_1] Driver test results:
[init -> vinit -> test_1]    tasks          19
[init -> vinit -> test_1]    threads        38
[init -> vinit -> test_1]    reads          8
[init -> vinit -> test_1]    writes         4
[init -> vinit -> test_1]    read tics      43796480
[init -> vinit -> test_1]    write tics     22152181
[init -> vinit -> test_1]    avg read tics  144067.375
[init -> vinit -> test_1]    avg write tics 145738.031
[init -> vinit -> test_1]    avg read ms    144.067
[init -> vinit -> test_1]    avg write ms   145.738

[init -> vinit -> test_1] Driver test results:
[init -> vinit -> test_1]    tasks          20
[init -> vinit -> test_1]    threads        40
[init -> vinit -> test_1]    reads          8
[init -> vinit -> test_1]    writes         4
[init -> vinit -> test_1]    read tics      49981851
[init -> vinit -> test_1]    write tics     25343403
[init -> vinit -> test_1]    avg read tics  156193.281
[init -> vinit -> test_1]    avg write tics 158396.281
[init -> vinit -> test_1]    avg read ms    156.192
[init -> vinit -> test_1]    avg write ms   158.395
